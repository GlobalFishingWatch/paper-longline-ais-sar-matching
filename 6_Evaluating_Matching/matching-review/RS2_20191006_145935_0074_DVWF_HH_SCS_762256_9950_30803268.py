...
scene_id = "RS2_20191006_145935_0074_DVWF_HH_SCS_762256_9950_30803268"

ssvids_to_find = ["220529000"]
...
print("total boats near footprint:", len(df_ais_near))

# +
print("unique scenes available in table:")
print("--------")

for scene in df_ais_near.scene_id.unique():
    print(scene)

# +
# w/ gear

matches_top = matches_top_gear
...
df_gfw_matches_gear = pd.read_gbq(q, project_id="world-fishing-827", dialect="standard")

# -

df_gfw_matches_gear.head()

print("matches including gear:", len(df_gfw_matches_gear))
...
print("matches excluding gear:", len(df_gfw_matches_no_gear))

# ## get mapping tools & components
...
df_ais_near_temp = df_ais_near[
    df_ais_near.scene_id == "RS2_20191006_145935_0074_DVWF_HH_SCS_762256_9950_30803268"
]
df_ais_near_temp.head()

df_gfw_matches_no_gear

for i in range(len(df_ksat_detections_temp)):
    print(df_ksat_detections_temp.reset_index(drop=True).Name[i])
